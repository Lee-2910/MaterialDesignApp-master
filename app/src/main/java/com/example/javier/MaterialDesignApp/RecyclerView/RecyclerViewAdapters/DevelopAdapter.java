...
public class DevelopAdapter extends RecyclerView.Adapter<DevelopAdapter.ViewHolder> {
    ...
    Context context;
    private ArrayList<AFilmModel> develops;


    // Adapter's Constructor
    public DevelopAdapter(Context context, ArrayList<AFilmModel> develops) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        textViewTitle.setText(develops.get(position).getTitle_en());
        textViewContent.setText(develops.get(position).getTitle_vn());
        Picasso.with(context).load(develops.get(position).getImages())
