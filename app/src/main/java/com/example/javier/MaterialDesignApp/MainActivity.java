...
public class MainActivity extends ActionBarActivity {
    ...
    public void navigationDrawer() {
        ...
        facebookID = sharedPreferences.getString("FACEBOOKID", "ly.tranminh");
    ...
    public void setFragment(int position) {
        ...
        switch (position) {
            case 0:
                ...
                fragmentTransaction.replace(R.id.fragment, fragmentFilms);
            ...
            case 1:
               ...
               /// fragmentTransaction.replace(R.id.fragment, VerticalFragment.newInstance());
                fragmentTransaction.commit();
                break;
        }
    }
